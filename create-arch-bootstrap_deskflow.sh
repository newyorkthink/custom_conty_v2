...
########################################################################
:<< 'NOTE'
deskflow 不能打包成appimage，其次conty 无法安装deskflow，缺少  libportal=0.6， 只能采用拷贝的方式放进去打包，
其次，这个程序最好单独打包。另外，synergy 最新版只能付费没有找到破解版的，并且采用的是qt6，个人建议synergy还是封装成独立的appimage
...
sudo cp -r ./sharedfolder/Downloads/bin/* ./custom_conty/root.x86_64/usr/bin/
sudo cp -r ./sharedfolder/Downloads/share/* ./custom_conty/root.x86_64/usr/share/
NOTE
...
export packagelist="ibus gtk3 yay qt6-base openssl pugixml libxtst libxrandr libxkbfile libxkbcommon-x11 libxkbcommon libxinerama libportal \
	libportal-gtk3 libnotify libei gdk-pixbuf2 base-devel m4 make pkgconf tomlplusplus gcc-libs glibc cmake meson libappindicator-gtk3 openssl-1.1 \
	hicolor-icon-theme libx11"

# If you want to install AUR packages, specify them in this variable
export aur_packagelist="deskflow-bin"
# cannot install
