...
########################################################################
:<< 'NOTE'
crossover 这个conty只能在本地，在github上打包的会出现polkit无法安装

sudo rm -rf ./custom_conty/root.x86_64/opt/cxoffice
sudo cp -r ./sharedfolder/Downloads/crossover/* ./custom_conty/root.x86_64/

################################
sudo cp -r ./sharedfolder/Downloads/usr/lib/lib32/* ./custom_conty/root.x86_64/usr/lib32/
sudo cp -r ./sharedfolder/Downloads/usr/lib/lib64/* ./custom_conty/root.x86_64/usr/lib64/
sudo cp -r ./sharedfolder/Downloads/usr/share/* ./custom_conty/root.x86_64/usr/share/
...
sudo cp -r ./sharedfolder/Downloads/license/data/* ./custom_conty/root.x86_64/opt/cxoffice/share/crossover/data/
sudo cp -r ./sharedfolder/Downloads/license/etc/* ./custom_conty/root.x86_64/opt/cxoffice/etc/

################################
# bug: (crossover:207413): Gtk-WARNING **: 23:41:28.161: im-xim.so: 无法打开共享目标文件: 没有那个文件或目录
# check: ls /usr/lib/gtk-3.0/3.0.0/immodules
sudo cp -r ./custom_conty/root.x86_64/usr/lib/gtk-3.0/3.0.0/immodules/im-*.so ./custom_conty/root.x86_64/usr/lib/
...
cannot install
lib32-nss-mdns lib32-libcapi lib32-libgphoto2 lib32-gst-plugins-bad lib32-gst-plugins-ugly lib32-gst-libav
ubuntu download
libnss-mdns:i386 libsane1:i386
NOTE
...
export packagelist="desktop-file-utils freetype2 glibc glu lcms2 lib32-freetype2 lib32-glibc lib32-glu lib32-lcms2 lib32-libglvnd lib32-libice lib32-libpng \
	lib32-libsm lib32-libx11 lib32-libxcursor lib32-libxext lib32-libxi lib32-libxrandr lib32-zlib libglvnd libice libpng libsm libx11 libxcursor libxext \
	libxi libxrandr python python-cairo python-gobject vte3 zlib yay tar alsa-lib fontconfig gnutls gsm lib32-alsa-lib lib32-fontconfig lib32-gnutls lib32-gcc-libs \
	lib32-libcups lib32-dbus lib32-libldap lib32-libpulse lib32-libxcomposite lib32-libxinerama lib32-libxml2 lib32-libxslt lib32-libxxf86vm lib32-mpg123 \
	lib32-openal lib32-openssl openssl lib32-v4l-utils libcups dbus libexif libgphoto2 libldap libpulse libxcomposite libxinerama libxml2 libxslt libxxf86vm \
	mpg123 nss-mdns nss ocl-icd openal sane unzip v4l-utils base-devel polkit git ibus gtk3 libcap unixodbc mesa libpcap pcsclite gst-plugins-base gst-plugins-good \
	gst-plugins-ugly gst-plugins-good gst-libav lib32-libpcap lib32-mesa lib32-gst-plugins-base lib32-gst-plugins-base-libs lib32-gst-plugins-good gstreamer \
	lib32-gstreamer lib32-pcsclite vulkan-icd-loader lib32-vulkan-icd-loader"

# If you want to install AUR packages, specify them in this variable
export aur_packagelist="crossover"
