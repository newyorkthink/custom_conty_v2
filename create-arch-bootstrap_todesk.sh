...
下次打包安装的时候，删除掉remotedesktopmanager
NOTE
...
export packagelist="ibus gtk3 gtk2 libxss pulseaudio libxcrypt-compat qt5-wayland qt5-base gdk-pixbuf2 pcmanfm-gtk3 alsa-lib libpulse base-devel yay feh libappindicator-gtk3 noto-fonts-cjk tar wget \
	wqy-bitmapfont wqy-microhei wqy-microhei-lite wqy-zenhei freetype2 nss nspr fuse2 fuse-common glibc pkgconf git hicolor-icon-theme gstreamer vte3 libsecret ca-certificates webkit2gtk-4.1 pulseaudio-alsa \
	lsof xdotool gst-plugins-base-libs gst-libav ca-certificates-utils lxterminal"

# If you want to install AUR packages, specify them in this variable
export aur_packagelist="todesk-bin firefox-esr-bin"
# cannot install
