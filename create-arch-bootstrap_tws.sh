...
ib-tws 无法封装
特别注意 archlinux 下的 gdk-pixbuf-2 是没有 libpixbufloader-svg.so 需要手动再复制一次，另外下次封装新版的 archlinux 可以再判断一次
NOTE
...
export packagelist="ibus gtk3 alsa-lib at-spi2-core bash cairo fontconfig freetype2 gcc-libs gdk-pixbuf2 glib2 glibc libx11 libxext libxrender libxtst libxxf86vm pango findutils libarchive sed ffmpeg \
	libglvnd wqy-microhei wqy-zenhei wqy-bitmapfont base-devel lxterminal git yay nspr nss"

# If you want to install AUR packages, specify them in this variable
export aur_packagelist="ib-tws firefox-esr-bin"
