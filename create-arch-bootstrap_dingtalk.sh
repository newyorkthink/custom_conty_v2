...
export packagelist="ibus gtk3 gtk2 libxss libxcrypt-compat qt5-wayland qt5-base gdk-pixbuf2 pcmanfm-gtk3 alsa-lib libpulse base-devel yay feh"

# If you want to install AUR packages, specify them in this variable
export aur_packagelist="dingtalk-bin firefox-esr-bin"
# cannot install
